...
async def create_payment_intent(
    ...
    return await payment_service.create_payment_intent_for_entity(db, request.entity_type, request.entity_id, request.phone_number, current_account, request.metadata)
